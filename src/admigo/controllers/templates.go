...
func GenerateHTML(writer http.ResponseWriter, r *http.Request, data interface{}, funcs map[string]any, filenames ...string) {
	if data == nil {
...
func GetHTMLAjax(data interface{}, funcs map[string]any, filenames ...string) (ret string, err error) {
	fm := getFm(funcs)
